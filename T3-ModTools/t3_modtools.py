...
I18N: dict[str, dict[str, str]] = {
    ...
    "ru": {
        "no_archives": "Файлы Game.cod/Patch*.cod или допустимый архив COD не найдены.",
        "opening_archive": "Открытие {name} ({entries} записей)",
        "combined_view": "Объединённое представление: {files} файлов",
        "outer_zip": "Внешний ZIP-архив содержит {count} файлов COD; подготовка временного доступа...",
        "no_binary_tree": "scene.sca не содержит cBinaryTree.",
        "map_shaders": "  Карта: шейдеров — {count}",
        "map_buffer": "  Буфер {buffer_id}: вершин — {count}",
        "map_tree": "  Дерево: списков — {lists}, уникальных треугольников — {triangles}",
        "extract_progress": "{kind}: извлечено файлов: {count}...",
        "extract_done": "{kind}: извлечено файлов: {count}; папка: {destination}",
        "effects": "Эффекты",
        "audio": "Аудио",
        "animations": "Анимации",
        "rigged_models": "Экспорт ригов (glTF 2.0)",
        "animation_summary": "Анимации: извлечено файлов ANM: {count}; папка: {destination}",
        "rigged_selected": "Выбрано моделей с ригом: {count}",
        "rigged_converting": "[{index}/{total}] Экспорт модели с ригом {path}",
        "rigged_ok": "  РИГ ОК: вершин — {vertices}, треугольников — {triangles}, костей — {bones}",
        "raw_progress": "Извлечено файлов: {count}...",
        "raw_done": "Извлечение исходных файлов завершено: {count}",
        "geometry_selected": "Выбрано файлов геометрии: {count}",
        "converting": "[{index}/{total}] Конвертация {path}",
        "no_submeshes": "Совместимые триангулированные подобъекты не найдены.",
        "conversion_ok": "  ОК: вершин — {vertices}, треугольников — {triangles}, материалов — {materials}",
        "texture_missing": "Текстура не найдена: {texture}",
        "texture_convert_failed": "Не удалось конвертировать текстуру для glTF: {texture} ({error})",
        "invalid_categories": "Недопустимые категории: {categories}",
        "done_cli": "Готово: {output}",
        "tk_unavailable": "Tkinter недоступен: {error}",
        "language": "Язык",
        "input_label": "Найдите и выберите Game.cod:",
        "output_label": "Папка назначения:",
        "browse": "Обзор",
        "select_input_title": "Выберите Game.cod",
        "game_cod_files": "Архив Game COD",
        "cod_files": "Архивы COD",
        "zip_files": "Резервные копии ZIP",
        "all_files": "Все файлы",
        "select_output_title": "Выберите папку назначения",
        "categories": "Категории",
        "characters": "Персонажи",
        "vehicles": "Транспорт",
        "weapons": "Оружие",
        "maps": "Карты",
        "menu_models": "Модели меню",
        "options": "Параметры",
        "convert_geometry": "Конвертировать SCA/LOD/DET в OBJ + MTL",
        "extract_raw": "Извлечь все исходные файлы",
        "include_lod": "Конвертировать LOD, даже если существует SCA",
        "all_lods": "Экспортировать все уровни LOD",
        "z_up": "Ось Z вверх (только для оружия и эффектов)",
        "flip_v": "Инвертировать координату V UV (не использовать для моделей glTF 2.0)",
        "ready": "Готово",
        "start": "Извлечь / Конвертировать",
        "select_category": "Выберите хотя бы одну категорию.",
        "finished_log": "ЗАВЕРШЕНО: {output}",
        "finished_message": "Экспорт завершён.\n\n{output}",
        "missing_paths": "Выберите Game.cod и папку назначения.",
        "error_title": "Ошибка",
        "warning_title": "Недостаточно данных",
    },
    "pt": {
        "no_archives": "Nenhum arquivo Game.cod/Patch*.cod ou arquivo COD válido foi encontrado.",
        "opening_archive": "Abrindo {name} ({entries} entradas)",
        "combined_view": "Visualização combinada: {files} arquivos",
        "outer_zip": "O ZIP externo contém {count} arquivos COD; preparando o acesso temporário...",
        "no_binary_tree": "scene.sca não contém cBinaryTree.",
        "map_shaders": "  Mapa: {count} shaders",
        "map_buffer": "  Buffer {buffer_id}: {count} vértices",
        "map_tree": "  Árvore: {lists} listas, {triangles} triângulos únicos",
        "extract_progress": "{kind}: {count} arquivos extraídos...",
        "extract_done": "{kind}: {count} arquivos extraídos para {destination}",
        "effects": "Efeitos",
        "audio": "Áudio",
        "animations": "Animações",
        "rigged_models": "Exportar rigs (glTF 2.0)",
        "animation_summary": "Animações: {count} arquivos ANM extraídos para {destination}",
        "rigged_selected": "Modelos com rig selecionados: {count}",
        "rigged_converting": "[{index}/{total}] Exportando modelo com rig {path}",
        "rigged_ok": "  RIG OK: {vertices} vértices, {triangles} triângulos, {bones} ossos",
        "raw_progress": "{count} arquivos extraídos...",
        "raw_done": "Extração de arquivos originais concluída: {count} arquivos",
        "geometry_selected": "Arquivos de geometria selecionados: {count}",
        "converting": "[{index}/{total}] Convertendo {path}",
        "no_submeshes": "Nenhuma submalha triangulada compatível foi encontrada.",
        "conversion_ok": "  OK: {vertices} vértices, {triangles} triângulos, {materials} materiais",
        "texture_missing": "Textura não encontrada: {texture}",
        "texture_convert_failed": "Não foi possível converter a textura para glTF: {texture} ({error})",
        "invalid_categories": "Categorias inválidas: {categories}",
        "done_cli": "Concluído: {output}",
        "tk_unavailable": "Tkinter não está disponível: {error}",
        "language": "Idioma",
        "input_label": "Localize e selecione Game.cod:",
        "output_label": "Pasta de saída:",
        "browse": "Procurar",
        "select_input_title": "Selecionar Game.cod",
        "game_cod_files": "Arquivo Game COD",
        "cod_files": "Arquivos COD",
        "zip_files": "Backups ZIP",
        "all_files": "Todos os arquivos",
        "select_output_title": "Selecionar pasta de saída",
        "categories": "Categorias",
        "characters": "Personagens",
        "vehicles": "Veículos",
        "weapons": "Armas",
        "maps": "Mapas",
        "menu_models": "Modelos do menu",
        "options": "Opções",
        "convert_geometry": "Converter SCA/LOD/DET para OBJ + MTL",
        "extract_raw": "Extrair todos os arquivos originais",
        "include_lod": "Converter LOD mesmo quando existir SCA",
        "all_lods": "Exportar todos os níveis LOD",
        "z_up": "Eixo Z para cima (somente para armas e efeitos)",
        "flip_v": "Inverter a coordenada V do UV (não usar com modelos glTF 2.0)",
        "ready": "Pronto",
        "start": "Extrair / Converter",
        "select_category": "Selecione pelo menos uma categoria.",
        "finished_log": "CONCLUÍDO: {output}",
        "finished_message": "Exportação concluída.\n\n{output}",
        "missing_paths": "Selecione Game.cod e uma pasta de saída.",
        "error_title": "Erro",
        "warning_title": "Informações ausentes",
    },
}
...
I18N["ru"].update({
    "mode_extraction": "Извлечение ресурсов",
    "mode_modding": "Моды",
    "game_folder": "Папка установки игры:",
    "mods_folder": "Папка модов:",
    "select_game_folder": "Выберите папку установки T3",
    "select_mods_folder": "Выберите папку модов",
    "mod_projects": "Проекты модов и порядок загрузки (чем выше, тем выше приоритет)",
    "create_mod": "Создать мод",
    "open_mod_files": "Открыть папку мода",
    "toggle_mod": "Включить / Отключить",
    "move_up": "Переместить вверх",
    "move_down": "Переместить вниз",
    "refresh": "Обновить",
    "build_mods": "Собрать моды + изменённый EXE",
    "install_loader": "Пересобрать изменённый EXE",
    "launch_modded": "Запустить T3 с модами",
    "mod_ready": "Режим модов готов",
    "mod_missing_paths": "Выберите папку установки игры и папку модов.",
    "mod_name_prompt": "Название мода:",
    "mod_author_prompt": "Автор (необязательно):",
    "mod_created": "Создан проект мода: {name}",
    "mod_building": "Сборка включённых модов и T3_Modded.exe...",
    "mod_build_done": "Собрано файлов: {files}; включённых модов: {mods}; результат: {output}",
    "mod_conflicts": "Конфликтов разрешено по порядку загрузки (побеждает верхний): {count}",
    "loader_installing": "Пересборка T3_Modded.exe из исходного T3.exe...",
    "loader_done": "Создан {output}. Исходный T3.exe не изменён.",
    "mod_launched": "T3_Modded.exe запущен",
    "no_mod_selected": "Сначала выберите проект мода.",
    "project_details": "{status} {name} | ID: {id} | Версия: {version} | Файлы: {files} | Патчи EXE: {patches}",
    "enabled": "ВКЛЮЧЁН",
    "disabled": "ОТКЛЮЧЁН",
    "modding_note": "Поместите файлы игры в files/, а необязательные манифесты патчей исполняемого файла — в patches/executable.json. При сборке все включённые моды объединяются в один Mods.Cod и один T3_Modded.exe. Для одинаковых файлов наивысший приоритет имеет верхний включённый мод.",
    "loader_note": "Команда сборки модов и изменённого EXE всегда пересоздаёт T3_Modded.exe из исходного T3.exe, загружает mods/Mods.Cod и применяет patches/executable.json из всех включённых модов. T3.exe остаётся неизменным.",
})
I18N["pt"].update({
    "mode_extraction": "Extração de recursos",
    "mode_modding": "Mods",
    "game_folder": "Pasta de instalação do jogo:",
    "mods_folder": "Pasta de mods:",
    "select_game_folder": "Selecionar a pasta de instalação do T3",
    "select_mods_folder": "Selecionar a pasta de mods",
    "mod_projects": "Projetos de mods e ordem de carregamento (o topo tem maior prioridade)",
    "create_mod": "Criar mod",
    "open_mod_files": "Abrir pasta do mod",
    "toggle_mod": "Ativar / Desativar",
    "move_up": "Mover para cima",
    "move_down": "Mover para baixo",
    "refresh": "Atualizar",
    "build_mods": "Compilar mods + EXE modificado",
    "install_loader": "Recompilar EXE modificado",
    "launch_modded": "Executar T3 com mods",
    "mod_ready": "Modo de mods pronto",
    "mod_missing_paths": "Selecione a pasta de instalação do jogo e a pasta de mods.",
    "mod_name_prompt": "Nome do mod:",
    "mod_author_prompt": "Autor (opcional):",
    "mod_created": "Projeto de mod criado: {name}",
    "mod_building": "Compilando os mods ativados e T3_Modded.exe...",
    "mod_build_done": "Compilados {files} arquivos de {mods} mods ativados: {output}",
    "mod_conflicts": "Conflitos resolvidos pela ordem de carregamento (vence o de cima): {count}",
    "loader_installing": "Recompilando T3_Modded.exe a partir do T3.exe original...",
    "loader_done": "Criado {output}. O T3.exe original não foi modificado.",
    "mod_launched": "T3_Modded.exe iniciado",
    "no_mod_selected": "Selecione primeiro um projeto de mod.",
    "project_details": "{status} {name} | ID: {id} | Versão: {version} | Arquivos: {files} | Patches EXE: {patches}",
    "enabled": "ATIVADO",
    "disabled": "DESATIVADO",
    "modding_note": "Coloque os arquivos nativos do jogo em files/ e os manifestos opcionais de patches do executável em patches/executable.json. A compilação combina todos os mods ativados em um único Mods.Cod e um único T3_Modded.exe. O mod ativado no topo tem maior prioridade para arquivos duplicados.",
    "loader_note": "Compilar mods + EXE modificado sempre recria T3_Modded.exe a partir do T3.exe original, carrega mods/Mods.Cod e aplica patches/executable.json de todos os mods ativados. T3.exe permanece intacto.",
})
...
def launch_gui() -> int:
    ...
    def rebuild_language_menu() -> None:
        ...
        for label, language_code in LANGUAGE_OPTIONS:
