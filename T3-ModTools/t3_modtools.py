...
I18N["en"].update({
    ...
    "mod_projects": "Mod projects and load order",
    ...
    "mod_conflicts": "Conflicts resolved by load order: {count}",
    ...
    "enabled": "ENABLED",
    "disabled": "DISABLED",
    "modding_note": "Put native game files under files/ and optional executable patch manifests under patches/executable.json. Build combines every enabled mod into one Mods.Cod and one T3_Modded.exe.",
...
I18N["es"].update({
    ...
    "mod_projects": "Proyectos de mods y orden de carga",
    ...
    "mod_conflicts": "Conflictos resueltos por orden de carga: {count}",
    ...
    "modding_note": "Colocá archivos nativos dentro de files/ y parches opcionales del ejecutable en patches/executable.json. La compilación combina todos los mods habilitados en un único Mods.Cod y T3_Modded.exe.",
